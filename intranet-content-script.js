...
try {
    ...
    const config = {
        padmModuleUrl: browser.runtime.getURL('modules/intranet/intranet-padm.js'),
        padmCssUrl: browser.runtime.getURL('modules/intranet/intranet-padm-styles.css'),
        uiModuleUrl: browser.runtime.getURL('modules/intranet/intranet-ui.js'),
    ...
    loaderScript.src = browser.runtime.getURL('intranet-loader.js');
