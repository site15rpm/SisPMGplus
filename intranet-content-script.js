...
try {
    ...
    const config = {
        ...
        praticasModuleUrl: chrome.runtime.getURL('modules/intranet/intranet-praticas.js'),
        praticasCssUrl: chrome.runtime.getURL('modules/intranet/intranet-praticas-styles.css'),
        ...
        sirconvConveniosModuleUrl: chrome.runtime.getURL('modules/intranet/intranet-sirconv-convenios.js'),
        sirconvConveniosCssUrl: chrome.runtime.getURL('modules/intranet/intranet-sirconv-convenios-styles.css'),
        ...
        unidadesModuleUrl: chrome.runtime.getURL('modules/intranet/intranet-unidades.js'),
        unidadesCssUrl: chrome.runtime.getURL('modules/intranet/intranet-unidades-styles.css'),
