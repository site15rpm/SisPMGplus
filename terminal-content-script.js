...
try {
    ...
    const config = {
        terminalModuleUrl: browser.runtime.getURL('modules/terminal/terminal.js'),
        cssUrl: browser.runtime.getURL('modules/terminal/terminal-styles.css'),
    ...
    loaderScript.src = browser.runtime.getURL('terminal-loader.js');
